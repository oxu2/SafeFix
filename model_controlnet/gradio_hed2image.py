...
model = create_model('/home/user/ControlNet/models/cldm_v15.yaml').cpu()
model.load_state_dict(load_state_dict('/home/user/ControlNet/models/control_sd15_hed.pth', location='cuda'))
model = model.cuda()
